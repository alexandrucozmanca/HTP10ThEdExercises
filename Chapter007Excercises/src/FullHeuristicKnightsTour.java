...
public class FullHeuristicKnightsTour
{
	...
	public static void main(String[] args)
	{
		for (int row = 0; row < board.length; row ++)
			for (int column = 0; column < board.length; column ++)
			{
				...
				// print tour results
				System.out.printf("Stoped after %d moves.%n%n", moves);
				//System.out.printf("Board after moves.%n");
				//printGrid(board);

				// print heuristic board after tour
				//System.out.printf("%nHeuristic Board after moves.%n");
				//printGrid(heuristicBoard);

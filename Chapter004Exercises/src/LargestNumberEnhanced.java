...
public class LargestNumberEnhanced 
{
	...
	{
		// instance variables
		int counter = 0, number, largest, leastLargest=0;
		...
		while (number != 0)
		{
			...
			{	
				...
				out.printf("A total of %d sales were registred and the largest was %d and least largest was %d.%n",counter,largest,leastLargest);
				input.close();
				break;
			}
			else 

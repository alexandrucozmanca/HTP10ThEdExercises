...
public class OneRoundPockerGame
{
	...
	public static void main (String[] arg)
	{
		...
		System.out.println("Evaluate your hand and decide which cards to exchange:");
		Scanner input = new Scanner(System.in);
		String answer = input.nextLine();
		exchangeCards(myHand, evaluateAnswer(answer));
		input.close();

		System.out.printf("%nDealer`s Hand after exchange:%n%s%n",printHand(dealerHand));
		System.out.printf("%nMy Hand after exchange:%n%s%n",printHand(myHand));
